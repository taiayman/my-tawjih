  ...
  Widget _buildMostajadatCategoryTab(String category) {
    ...
    return mostajadatAsyncValue.when(
      data: (mostajadatList) {
        ...
        if (categoryMostajadat.isEmpty) {
          return Center(child: Text('no_mostajadat_found'.tr()));
        } else {
              ...
              if (index == 0) {
                return Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text('add_mostajadat'.tr()), // Using tr() function 
                    style: ElevatedButton.styleFrom(
                      foregroundColor: Colors.white,
                      backgroundColor: accentColor,
                      padding: EdgeInsets.symmetric(vertical: 12),
...
class _AddMostajadatDialogState extends ConsumerState<AddMostajadatDialog> {
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      // Pass _type to MostajadatCustomizationScreen
      Navigator.of(context).push(MaterialPageRoute(
        builder: (context) => MostajadatCustomizationScreen(
          ...
          imageUrl: imageUrl,
          type: _type, // Pass the selected type here
